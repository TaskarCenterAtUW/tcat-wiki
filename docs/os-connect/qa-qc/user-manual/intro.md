---
title: Understanding QA/QC Reporting for OS-CONNECT
nav_order: 1
tags:
    - Guide
    - External
...
This page describes the context and goals of the OS-CONNECT QA/QC reports.
...
- [Intro: Understanding QA/QC Reporting for OS-CONNECT](intro.md)
...
Next section: [Data Sources and OS-CONNECT QA/QC Report Structure](structure.md)
