...
doc_type: concept
questions:
    - What audience baseline can guide TCAT documentation?
    - How can mapping documentation support new learners?
audiences:
    - developer
    - planner
    - advocate
...
The baseline does not replace audience-specific guidance for developers, jurisdictions, or experienced mappers. It is a minimum readability target, not a complete description of every reader.
...
- [Assistant Knowledge Base schema](../../schema.md)
