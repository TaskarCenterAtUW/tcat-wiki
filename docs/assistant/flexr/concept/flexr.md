...
FleXR is a TCAT research project that lets people use their own custom input systems — instead of standard head-mounted displays and hand controllers — to access Extended Reality (XR) applications. It is built as a plugin for A-Frame, a WebXR framework, so it can be added to new and existing XR applications.

## Significance

Most XR applications assume users can physically move a head-mounted display and hold hand controllers. This excludes people who cannot use those standard input methods, including many people with motor disabilities. FleXR's prototype demonstrates that input systems for XR can be standardized and swapped out, widening who can participate in XR experiences.
...
A developer with an existing A-Frame application wants to make it usable by people who cannot hold standard hand controllers. They integrate the FleXR plugin following its specification, allowing users to connect a custom input system instead.
...
- [FleXR — Assistant Knowledge Base](../index.md)
- [Get Involved with FleXR](../workflow/get-involved-with-flexr.md)
