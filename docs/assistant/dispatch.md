...
| `draft` | 362 | Content authored; awaiting TCAT editorial review |
...
| :-------------- | ----: | :------ |
| `provisional` | 398 | Early or limited-confidence guidance |
| `explanatory` | 390 | Established explanation without formal policy authority |
