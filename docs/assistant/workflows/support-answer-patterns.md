...
A county asks how long a viewer-reported fix takes. Use **`answer-when-uncertain`** if release timing is unknown: state the public release model, note that timelines vary by validation queue, name who will confirm, and link [How long do corrections take to appear in a public release?](../questions/os-connect/how-long-do-corrections-take-to-appear-in-a-public-release.md).
