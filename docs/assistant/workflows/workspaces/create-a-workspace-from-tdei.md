...
- Point procedural detail to the [TCAT Wiki Workspaces section](../../../workspaces/index.md) and TDEI portal user manual for jobs and registration; do not invent UI labels beyond what documentation and the cited workshop materials describe.
...
- [Workspace sandbox](../../concepts/workspaces/workspace-sandbox.md) *(stub—author next)*
- [Dataset lineage (Workspaces and TDEI)](../../concepts/workspaces/dataset-lineage.md) *(stub—author next)*
- [TDEI vs Workspaces](../../concepts/workspaces/tdei-vs-workspaces.md) *(stub—author next)*
- [How do I create a workspace from TDEI?](../../questions/workspaces/how-do-i-create-a-workspace-from-tdei.md) *(stub—author next)*
- [What happens when I create a workspace from a TDEI dataset?](../../questions/workspaces/what-happens-when-i-create-a-workspace-from-a-tdei-dataset.md) *(stub—author next)*
