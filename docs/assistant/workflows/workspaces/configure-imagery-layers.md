...
- Pair with [imagery layers concept](../../concepts/workspaces/imagery-layers.md) *(stub)* when authored.
...
- [Imagery layers (Workspaces)](../../concepts/workspaces/imagery-layers.md) *(stub—author in Phase B)*
