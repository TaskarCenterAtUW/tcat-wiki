...
This guide covers how to validate mapped pedestrian infrastructure tasks in the OSM US Tasking Manager for the [OpenThePaths 2026 Mappy Hour](index.md) event.
