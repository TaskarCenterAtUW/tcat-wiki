...
This guide covers how to map pedestrian infrastructure for the [OpenThePaths 2026 Mappy Hour](index.md) event.

---

### Quick Links

- **Event Page**: [OpenThePaths 2026](https://tcat.cs.washington.edu/OTP2026/)
...
3. Select **Map selected task** to open the Rapid / iD Editor
...
1. Click **Save** in the editor (top right)
