...
## Olympia, Connected: Mapping for Mobility in OpenStreetMap — Event Summary Report
...
Mappers contributed to **[Project #1083 — Olympia, WA, US: Pedestrian Infrastructure | #OpenSidewalks](https://tasks.openstreetmap.us/projects/1083)** via the OSM US Tasking Manager, adding pedestrian infrastructure data to OpenStreetMap.
