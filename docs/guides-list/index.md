...
### [Long Form Quests – Overview](../tdei/producers/workspaces/aviv-scoutroute/long-form/guides/long-form-overview.md)

A high-level overview of Long Form Quests and links to the related setup guides.

### [Create a Workspace in TDEI Portal](../tdei/producers/workspaces/aviv-scoutroute/long-form/guides/creating-workspace.md)

This guide explains how to create a Workspace from the TDEI Portal and verify it in Workspaces.

### [Add Long Form Quest Definitions to a Workspace](../tdei/producers/workspaces/aviv-scoutroute/long-form/guides/adding-longform-quests.md)

This guide explains how to attach Long Form Quest Definition JSON (v3.0.0) to a Workspace, either inline or via external URL.

### [Configure Custom Imagery](../tdei/producers/workspaces/aviv-scoutroute/long-form/guides/configuring-custom-imagery.md)

This guide explains how to configure Custom Imagery sources (e.g., satellite layers) for use in AVIV ScoutRoute.
