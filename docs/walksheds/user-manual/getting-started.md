...
!!! info "Account Required"
    ...
    A TDEI account is required to use the Walksheds tool. If you do not have one, register at [portal.tdei.us](https://portal.tdei.us/) before signing in.
